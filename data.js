...
// 8 Aussagen pro Bereich (gleich viele!)
const QUESTIONS = [
  // logisch (8)
  ...
  { id:"l7", intel:"logisch", text:"Ich mag Knobelaufgaben, bei denen man schätzen muss (Fermi-Aufgaben: grob, aber clever)." },
  { id:"l8", intel:"logisch", text:"Ich überprüfe gern, ob eine Lösung wirklich stimmen kann (z.B. durch Rückwärtsrechnen)." },
  ...
  { id:"r7", intel:"raeumlich", text:"Ich mag es, Dinge genau anzuschauen und Details zu entdecken (z.B. in Bildern, Plänen)." },
  { id:"r8", intel:"raeumlich", text:"Ich finde Aufgaben spannend, bei denen man etwas im Raum anordnen muss (z.B. Tetris, Tangram, Modelle)." },
  ...
  { id:"k7", intel:"koerper", text:"Ich mag Sportspiele und Wettkämpfe (z.B. Turniere) und gebe gern Vollgas." },
  { id:"k8", intel:"koerper", text:"Ich kann Bewegungen gut nachmachen oder üben (z.B. Tanzschritte, Sporttechnik, Bühnenbewegung)." },
  ...
  { id:"m7", intel:"musikalisch", text:"Ich würde gern im Chor singen oder gemeinsam mehrstimmig singen lernen." },
  { id:"m8", intel:"musikalisch", text:"Ich mag Musicals oder Theater mit Musik und finde es spannend, wenn Sprache und Musik zusammenkommen." },
  ...
  { id:"i7", intel:"inter", text:"Ich würde gerne als Delegierte*r im Schülerrat mitmachen (Schülerrat = Delegierte aus den Klassen)." },
  { id:"i8", intel:"inter", text:"Ich kann gut vermitteln, wenn es Streit gibt, und suche gern eine faire Lösung." },
  ...
  { id:"s7", intel:"sprachlich", text:"Ich schreibe gern Gedichte oder kurze Texte mit Reimen und Rhythmus." },
  { id:"s8", intel:"sprachlich", text:"Ich halte gerne Vorträge oder Präsentationen und übe das auch." },
  ...
  { id:"p7", intel:"intra", text:"Wenn etwas schwierig ist, bleibe ich oft dran, auch wenn es länger dauert." },
  { id:"p8", intel:"intra", text:"Ich überlege gern, welche Arbeit zu mir passt (z.B. lieber kreativ, sportlich, technisch, ruhig)." },
  ...
  { id:"e7", intel:"exist", text:"Ich interessiere mich für Religion, Ethik oder Philosophie – auch wenn es kompliziert ist." },
  { id:"e8", intel:"exist", text:"Ich denke darüber nach, wie wir gut zusammenleben können (Regeln, Werte, Verantwortung)." },
  ...
  { id:"n7", intel:"natur", text:"Ich sammle oder ordne gern Natur-Dinge (Steine, Blätter) und vergleiche sie." },
  { id:"n8", intel:"natur", text:"Ich möchte verstehen, wie Umwelt und Klima zusammenhängen und was wir tun können." },
];
...
const PROJECTS = [
  ...
  // Schule/Angebote
  { id:"pr_theater",    name:"Schultheater & Musical (spielen, proben, aufführen)", tags:["Bühne/Rollen/Proben"],                  intels:["sprachlich","inter","koerper","musikalisch"] },
  { id:"pr_choir",      name:"Singen im Chor (gemeinsam singen lernen)",            tags:["Chor/Mehrstimmigkeit"],                 intels:["musikalisch","inter","sprachlich"] },
  { id:"pr_tournament", name:"Sport: Schülerturniere (Teamspiele/Wettkampf)",       tags:["Team/Sportspiele"],                     intels:["koerper","inter","intra"] },
  { id:"pr_waedifisch", name:"Schwimmwettkampf «Wädifisch» (Training & Wettkampf)", tags:["Schwimmen/Start/Technik"],              intels:["koerper","intra","inter"] },
];
